...
class ReleaseTest {
    ...
    private static Release myrelease;
    ...
    static void setUp() {
        ...
        //Test for release without tracks
        myrelease = new Release("myrelease");
        myrelease.setArtist("Me");
        myrelease.setTitle("The Best Song");
    ...
    @Test
    void testToString(){
        assertEquals(madonnaAngelUKMaxiSingle.toString(), "ID: 56f72e41-1060-4926-b77d-58d7b2a4df86\n" +
                "Artist: Madonna\nTitle: Angel (UK 12\" Single)\n" +
                "Tracklist: Angel (Extended Dance Mix)\nBurning Up\n");
        assertEquals(myrelease.toString(), "ID: myrelease\nArtist: Me\nTitle: The Best Song\nTracklist: Empty\n");
    }
    @Test
    void testException(){
        String recBeatlesPennyLane = "5a6becfb-07e3-4286-8de0-5b4fa826f3f2";
        assertThrows(ArrayStoreException.class, () -> beatlesSFFPennyLane.addTrack(new Track("AA", recBeatlesPennyLane,"The Beatles", "Penny Lane", 178)));
    }
    //No need to cover all the getters for their simplicity
}
